...
//01.22 添加返回到主页面的数组
//#import "AddProvideViewController.h"
...
-(void)complete:(UIButton *)sender{
    NSLog(@"完成了,跳到主发布页面");
//    AddProvideViewController * provide = [[AddProvideViewController alloc]init];
//    provide.imgeArray = [NSMutableArray arrayWithArray:self.arrayOK];
//    
//    [self.navigationController pushViewController:provide animated:YES];
